...
# --------------------------------------NO EDITS BELOW------------------------------------------------------------------
# ----------------------------------------------------------------------------------------------------------------------
# board = PLATFORM.RHODES
# variant = BOARD_VARIANT.V2
...
def UWB_SR100_Ranging_test():
    ...
    while test_count<3:
        ...
        state_ntf_rx = serial_trx(scpi_rx, "UWB ANTPAIR 1\r\n") # Set PDOA offset to responder
        print(state_ntf_rx)
        state_ntf_rx = serial_trx(scpi_rx, "UWB PDOAOFFSET -60\r\n") # Input offset value
        print(state_ntf_rx)
